...
import forgot_pass from "../../assets/Forgot password.svg";
...
export default function Login({ toggleModal, loginButton }) {
  ...
  const clickLogin = () => {
    if (lusername === "" || lusername === undefined || lpassword === "" || lpassword === undefined) {
      setSnackMessage("Field cannot be blank!");
      setOpenSnack(true);
    } else {
  ...
  return (
    <React.Fragment>
        ...
        <Grid item xs={12}>
          <DialogContent>
            ...
            <div>
              ...
              <div className=" min-h-screen  flex items-center justify-center px-5 py-5 -mt-20">
                <div className="bg-indigo-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: '1000px' }}>
                  <div className="md:flex w-full">
                    <div className="hidden md:block w-1/2 bg-orange-500 py-10 px-10">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                      <div className="text-center mb-10">
                        <h1 className="font-bold text-3xl text-gray-900">Please signin</h1>
                        <br></br>
                        <span style={{
                          fontWeight: 'bold',
                          color: 'red',
                      ...
                      <div>
                        <div>
                          <div className="relative mb-6">
                            <div class="relative">
                              <input type="email" value={lusername} onChange={lusernameChange} id="floating_outlined" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                              <label for="floating_outlined" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-100 dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">E-mail</label>
                            </div>

                          </div>
                        </div>
                        <div class="relative mb-6">
                          <input type="password" value={lpassword} onChange={lpasswordChange} id="floating_outlined" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                          <label for="floating_outlined" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-100 dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Password</label>
                        </div>
                        ...
                        <span onClick={toggleForgotPassModal} class="cursor-pointer text-blue-600">Forgot password?</span>
                        <br></br><br></br>
                        <div className="flex -mx-3">
                          <div className="w-full px-3 mb-5">
                            <button onClick={clickLogin} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Log In</button>
                          </div>
                        </div>
                        <div className="flex justify-center">
                          <span onClick={toggleSignUpModal} class="cursor-pointer text-blue-600 ">Dont had an account? Sign Up</span>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <Dialog open={isForgotPassOpen} onClose={toggleForgotPassModal} fullWidth maxWidth="md">
      ...
      <Dialog open={isSignUpOpen} onClose={toggleSignUpModal} fullWidth maxWidth="md">
